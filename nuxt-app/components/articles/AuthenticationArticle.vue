      ...
      <div class="flex-parent-element">
        ...
        <div class="flex-child-element context content">
          ...
          <p>
            ...
            using a social account like Google so they wouldn’t have to remember
          ...
          <p>
            ...
            able to sign up, sign in, and reset their password without support.
            The user flow should be simple and familiar.
          </p>
          <p>
          ...
          <p>
            Microsoft positions Entra External ID as the next stage evolution to
            seamlessly unite secure and engaging experiences for a wide range of
            external identities including customers and partners as citizens
            within a single cohesive platform. Whereas AD B2C is basically used
            to build customer facing applications only.
          </p>
          <p>
            I like the vision of Entra External ID. That’s been my mental model
            of how identities work. All excitement aside, the AD B2C does what I
            need today and is inexpensive under the pay as you go model. The
            first 50,000 monthly active users (MAU) are free.
          </p>
          <p>
            I chose AD B2C because it is a mature product that does what I need,
            is easy to use and has a lot of documentation. I can always switch
            to Entra External ID later if I need to.
          </p>
        </div>
      </div>
    </div>
